<template>
    ...
    <svg v-if="name == 'filter'" :width="$attrs.width || 21" :height="$attrs.heigth || 16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg" v-bind="$attrs">
    ...
    <svg v-if="name == 'user'" :width="$attrs.width || 24" :height="$attrs.heigth || 24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" v-bind="$attrs">
        <path d="M11 14.062V20H13V14.062C16.946 14.554 20 17.92 20 22H4C4.00003 20.0514 4.71119 18.1698 6 16.7083C7.28882 15.2467 9.0667 14.3058 11 14.062V14.062ZM12 13C8.685 13 6 10.315 6 7C6 3.685 8.685 1 12 1C15.315 1 18 3.685 18 7C18 10.315 15.315 13 12 13Z" :fill="$attrs.color || 'white'" />
    </svg>

    <svg v-if="name == 'clipboard'" :width="$attrs.width || 24" :height="$attrs.heigth || 24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" v-bind="$attrs">
