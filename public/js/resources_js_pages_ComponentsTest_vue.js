...
/* harmony import */ var _miscellaneous_CheckBox_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./miscellaneous/CheckBox.vue */ "./resources/js/components/miscellaneous/CheckBox.vue");
/* harmony import */ var _miscellaneous_SelectOptions_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./miscellaneous/SelectOptions.vue */ "./resources/js/components/miscellaneous/SelectOptions.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    CheckBox: _miscellaneous_CheckBox_vue__WEBPACK_IMPORTED_MODULE_3__["default"],
    SelectOptions: _miscellaneous_SelectOptions_vue__WEBPACK_IMPORTED_MODULE_4__["default"]
  },
  props: {
    checkboxes_options: {
      type: Array,
  ...
  setup: function setup(props, context) {
    ...
    var sel = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)([]);

    for (var index = 0; index < props.select_options.length; index++) {
      sel.value[index] = {
        value: "",
    ...
    var checkboxes = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)([]);
    checkboxes = props.checkboxes_options;
    store.dispatch("".concat(_store_types_types__WEBPACK_IMPORTED_MODULE_1__.FILTER_MODULE, "/").concat(_store_types_types__WEBPACK_IMPORTED_MODULE_1__.SET_ITEMS), checkboxes);

    var resetFilter = function resetFilter() {
      console.log("reset");
      store.dispatch("".concat(_store_types_types__WEBPACK_IMPORTED_MODULE_1__.FILTER_MODULE, "/").concat(_store_types_types__WEBPACK_IMPORTED_MODULE_1__.RESET_FILTER));
      context.emit("update:modelValue", []);

      for (var _index = 0; _index < props.select_options.length; _index++) {
        sel.value[_index] = {
          value: "",
          label: props.select_options[_index].label
        };
      }
    };

    var validate = function validate() {
      context.emit("update:modelValue", store.state[_store_types_types__WEBPACK_IMPORTED_MODULE_1__.FILTER_MODULE].selected_items);
    };
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.watch)(function () {
      ...
      if (current_val.length == 0) {
        checkboxes.value = store.state[_store_types_types__WEBPACK_IMPORTED_MODULE_1__.FILTER_MODULE].items;
      }
    });
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.watch)(function () {
      return lodash__WEBPACK_IMPORTED_MODULE_2___default().cloneDeep(sel.value);
    }, function (current_val, previous_val) {
      store.commit("".concat(_store_types_types__WEBPACK_IMPORTED_MODULE_1__.FILTER_MODULE, "/").concat(_store_types_types__WEBPACK_IMPORTED_MODULE_1__.SET_SELECTED_BOXES), current_val);
    });
    return {
      checkboxes: checkboxes,
      sel: sel,
      open: open,
      isColored: (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(function () {
        if (store.state[_store_types_types__WEBPACK_IMPORTED_MODULE_1__.FILTER_MODULE].selected_items.length > 0) {
          return "colored";
        }
      }),
      resetFilter: resetFilter,
      updateSelectedList: function updateSelectedList(event) {
        return store.dispatch("".concat(_store_types_types__WEBPACK_IMPORTED_MODULE_1__.FILTER_MODULE, "/").concat(_store_types_types__WEBPACK_IMPORTED_MODULE_1__.SET_SELECTED_BOXES), [{
          id: event.id,
          value: event.name,
          check: event.check
        }]);
      },
      selected_items: (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(function () {
        return store.state[_store_types_types__WEBPACK_IMPORTED_MODULE_1__.FILTER_MODULE].selected_items;
      }),
      validate: validate
    };
  }
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [_hoisted_5, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" \r\n                <div class=\"rectangle\"></div>\r\n                <div class=\"rectangle2\"></div>\r\n                <div class=\"rectangle3\"></div> ")], 2
  /* CLASS */
  )]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["items", {
      selectHide: !$setup.open
    }])
  }, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($setup.checkboxes, function (checkboxes, index) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
      "class": "checkboxes",
      key: index
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(checkboxes.name) + " :", 1
    /* TEXT */
      ...
      return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
        ...
        "onUpdate:checked_checkbox": function onUpdateChecked_checkbox($event) {
          return option.check = $event;
        },
        checked_checkboxModifiers: {
          sync: true
        },
        name: option.value,
        ...
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(option.value), 1
          /* TEXT */
          )];
        }),
        _: 2
      ...
      /* PROPS, DYNAMIC_SLOTS */
      , ["id", "checked_checkbox", "onUpdate:checked_checkbox", "name", "onCheckboxClicked"])]);
    }), 128
    /* KEYED_FRAGMENT */
    ))]);
  }), 128
  /* KEYED_FRAGMENT */
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_select_options, {
      key: index,
      modelValue: $setup.sel[index].value,
      "onUpdate:modelValue": function onUpdateModelValue($event) {
        return $setup.sel[index].value = $event;
      },
    ...
    /* PROPS */
    , ["modelValue", "onUpdate:modelValue", "options", "name", "label"]);
  }), 128
  /* KEYED_FRAGMENT */
...
/* harmony import */ var C_xampp_8_htdocs_lcdt_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
/* harmony import */ var C_xampp_8_htdocs_lcdt_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,C_xampp_8_htdocs_lcdt_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_ComponentsTest_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_ComponentsTest_vue_vue_type_template_id_0ab7ae91__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/pages/ComponentsTest.vue"]])
/* hot reload */
if (false) {}
